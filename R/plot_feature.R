...
plot_feature_text = function(x,text,fontsize=12,side=0, col="black",xjust=unit(0,"npc"), yjust=unit(0,"npc"), plotBottomToTop=TRUE,debug=FALSE){
    ...
    grid.text(text, x =unit(xtext,"native"), y = unit(ytext,"points"),just="center",
